                            ...
                            <div className="flex flex-col gap-4 mb-10">
                                {requests.map((req) => (
                                    <div key={req.id} className="glass-card rounded-2xl p-5 border-white/5 flex items-center gap-4 hover:border-white/10 transition-all group">
                                        <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center text-turbo-orange group-hover:scale-110 transition-transform overflow-hidden border border-white/5">
