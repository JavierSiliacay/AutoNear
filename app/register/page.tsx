                ...
                {!message.type || message.type === 'error' ? (
                    <>
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full h-12 bg-white text-midnight font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-gray-100 transition-all border border-gray-200 mb-6 disabled:opacity-50"
                        >
                            ...
                            <span className="text-xs uppercase tracking-wider font-black">Continue with Google</span>
                        </button>
                        ...
                        <div className="relative mb-6">
                            ...
                            <div className="relative flex justify-center text-[10px] uppercase font-black tracking-widest text-muted-foreground/50">
                                <span className="bg-midnight px-4">Or sign up with email</span>
                            </div>
                        </div>
